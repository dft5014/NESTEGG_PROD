...
async def update_all_metrics(
    ...
    try:
        ...
        all_tickers = await get_all_active_tickers()
        ...
        event_id = await create_update_event(
            "all_metrics_update",
            f"Updating metrics for {total_tickers} tickers"
        )
...
async def update_all_prices(
    ...
    try:
        ...
        event_id = await create_update_event(
            "all_prices_update",
            f"Updating prices for {total_tickers} tickers"
        )
        ...
        for i in range(0, total_tickers, batch_size):
            ...
            try:
                ...
                # If batch lookup fails, mark all tickers in this batch as failed
