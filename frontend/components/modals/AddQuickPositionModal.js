                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        ${isSelected
                          ? 'bg-gradient-to-r from-blue-900/50 to-blue-800/50 hover:from-blue-800/50 hover:to-blue-700/50'
                          : 'hover:bg-gray-800'
                        }
                      `}
                    >
                ...
                {selectedIds.size > 0 && (
                  <div className="flex items-center space-x-2 px-3 py-2 bg-rose-500/10 rounded-lg border border-rose-500/30 shadow-sm animate-in slide-in-from-left duration-200">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 text-xs bg-rose-500/20 text-rose-400 font-medium rounded-md hover:bg-rose-500/30 border border-rose-500/50 transition-all flex items-center space-x-1.5"
                    >
