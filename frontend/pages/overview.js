...
const Overview = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative overflow-hidden px-6 py-24 sm:py-32 lg:px-8">
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            Your complete guide to tracking net worth securely and effectively
          </p>
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <div className="bg-white/80 backdrop-blur rounded-lg p-6 border border-gray-200">
                ...
                <p className="text-gray-700 mb-3">
                  Research shows that active engagement with your finances leads to better outcomes. Studies on financial monitoring indicate that individuals who actively monitor their financial accounts show significantly better financial outcomes and are more likely to achieve their long-term financial goals compared to those who use passive tracking methods.
                </p>
                <blockquote className="italic border-l-4 border-blue-500 pl-4 my-4 text-gray-600">
                  "Numerous studies show that monitoring progress helps people to achieve their goals" - from research on personal finance monitoring behavior
                </blockquote>
                <p className="text-sm text-gray-500">
                  Source: Personal Finance Monitoring Research Studies
                </p>
              </div>
              <p className="text-lg leading-relaxed">
      ...
      {/* How It Works Section - FIXED VISIBILITY */}
      <section id="how-it-works" className="px-6 py-16 lg:px-8">
      ...
      {/* Features Grid */}
      <section id="features" className="px-6 py-16 lg:px-8 bg-gray-50">
        <div className="mx-auto max-w-6xl">
      ...
      {/* Balance Sheet Focus */}
      <section id="balance-sheet" className="px-6 py-16 lg:px-8 bg-white">
        <div className="mx-auto max-w-4xl">
      ...
      {/* Pro Tips Section - FIXED VISIBILITY */}
      <section id="tips" className="px-6 py-16 lg:px-8 bg-gray-50">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Pro Tips for NestEgg Success</h2>
          
          <div className="space-y-6">
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300">
              <h3 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
                <Clock className="w-5 h-5 text-blue-600" />
                Set a Monthly Reconciliation Reminder
              </h3>
              <p className="text-gray-600">
                Pick a specific day each month (like the 1st or 15th) to reconcile your accounts. Consistency makes it a habit, and habits lead to wealth.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">
                Include all accounts - even that old 401(k) or savings bond. A complete picture helps you make better decisions about your entire financial life.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300">
              <h3 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
                ...
                Use Tax Lots for Better Insights
              </h3>
              <p className="text-gray-600">
                When adding investment positions, include purchase dates and cost basis. This unlocks powerful analytics about your investment performance and tax implications.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600">
                Got a raise? Bought a house? Received an inheritance? Update your NestEgg immediately to keep your financial picture accurate.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Help Section - Replaced CTA */}
      <section className="px-6 py-16 lg:px-8 bg-gradient-to-br from-blue-600 to-green-600 text-white">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-6">Need More Help?</h2>
          <p className="text-xl mb-8 text-blue-100">
            Check out our detailed guides or reach out to support
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-white/20 backdrop-blur text-white px-6 py-3 rounded-lg font-medium hover:bg-white/30 transition-all duration-300 border border-white/30">
              View Detailed Guides
            </button>
            <button className="bg-white text-blue-600 px-6 py-3 rounded-lg font-medium hover:bg-blue-50 transition-all duration-300">
              Contact Support
            </button>
          </div>
        </div>
